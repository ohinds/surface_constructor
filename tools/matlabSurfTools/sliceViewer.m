...
function h = sliceViewer(vol,slices,dim,anim,slice_num,box)
    global colors
    ...
    if(slice_num > 0)
        showslice(vol,slices,slice_num,dim,axisrange);
    ...
    fr = 1;
    while(1)
        showslice(vol,slices,fr,dim,axisrange);
...
function showslice(vol,slices,n,dim,axisrange)
    global colors
